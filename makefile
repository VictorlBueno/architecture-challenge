...
# Entra na pasta k8s e faz o start
start:
...
clean:
	...
	@cd k8s-app && kubectl delete -f . || true
	@cd ../k8s-db && kubectl delete -f . || true
...
help:
	   ...
	   @echo "  make start      - Iniciar toda a aplicação"
